...
def describe_and_greet(image_path, person_name):
   base64_image = preprocess_image(image_path, IMAGE_RESOLUTION)

   user_prompt = USER_PROMPT_TEMPLATE.format(name=person_name)
